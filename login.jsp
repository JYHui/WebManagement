...
<body>
	...
	<div class="login" style="margin-top: 50px;">
			...
			<div class="web_login" id="web_login">
				...
				<div class="login-box">
					...
					<div class="login_form">
						<form action="loginctrl" name="loginform" accept-charset="utf-8"
		...
		<div class="qlogin" id="qlogin" style="display: none;">
			...
			<div class="web_login">
				<form name="form2" id="regUser1" accept-charset="utf-8"
					action="registerctrl" method="post">
					...
					<ul class="reg_form" id="reg-ul">
						...
						<li><label for="user" class="input-tips2">性别：</label>
							<div class="inputOuter2">
								<input type="text" id="sex1" name="sex" 
									class="inputstyle2" />
							</div></li>
						...
						<li><label for="qq" class="input-tips2">QQ：</label>
							<div class="inputOuter2">
								...
								<input type="text" id="qq1" name="qq" 
									class="inputstyle2" />
							</div></li>

						<li>
							<div class="inputArea">
								<input type="submit" id="reg1"
